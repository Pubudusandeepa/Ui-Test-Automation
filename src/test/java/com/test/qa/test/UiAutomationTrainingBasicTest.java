...
//		softAssert.assertAll();
	...
	public void testVerifyLogin() {
		...
		softAssert.assertTrue(LoginSecurePage.getAlertContent().contains(Constants.LOGIN_SUCCESS_MSG), "Login Alert is not Displayed");
		LoginSecurePage.clickLogout();
		softAssert.assertTrue(LoginPage.isLoginPageDisplayed(), "Login page is not Displayed");
		softAssert.assertTrue(LoginPage.isLooutAlertPageDisplayed(), "Logout Alert is not Displayed");
		softAssert.assertTrue(LoginSecurePage.getAlertContent().contains(Constants.LOGOUT_SUCCESS_MSG), "Login Alert content is valid");
		softAssert.assertAll();
	}
	...
	public void testVerifyInvalidLogin() {
		...
		softAssert.assertTrue(HomePage.isHomePageDisplayed(), "Home Page is not Displayed");
		HomePage.clickLink(Constants.LOGIN_LINK);
		LoginPage.SetUserNameAndPassword(Constants.USER_NAME, Constants.PASSWORD);
		LoginPage.clickSubmit();
		softAssert.assertTrue(LoginPage.invalidLoginAlertDisplayed(), "Invalid Login alert  is not Displayed");
		softAssert.assertTrue(LoginSecurePage.getAlertContent().contains(Constants.LOGIN_INVALID_MSG), "Invalid Message is not correct");
		softAssert.assertAll();
	}
}
